...
class EstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post estados_url, params: { estado: { id_est_den: @estado.id_est_den, nom_est: @estado.nom_est } }
    end
  ...
  test "should update estado" do
    patch estado_url(@estado), params: { estado: { id_est_den: @estado.id_est_den, nom_est: @estado.nom_est } }
